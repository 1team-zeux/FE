...
const mockTopologies: TopologyDraft[] = [
  {
    ...
    nodes: [
      { nodeId: 'route53-1', type: 'route53',    label: 'Route 53',     x: 60,  y: 300 },
      { nodeId: 'alb-1',     type: 'elb',        label: 'ALB',          x: 255, y: 195, parentGroupId: 'g-pub' },
      { nodeId: 'nat-1',     type: 'nat',        label: 'NAT GW',       x: 255, y: 490, parentGroupId: 'g-pub' },
      { nodeId: 'ec2-1',     type: 'ec2',        label: 'EC2 (AZ-a)',   x: 482, y: 165, parentGroupId: 'g-priv-a' },
      { nodeId: 'ec2-2',     type: 'ec2',        label: 'EC2 (AZ-c)',   x: 482, y: 480, parentGroupId: 'g-priv-c' },
      { nodeId: 'rds-1',     type: 'rds',        label: 'RDS Primary',  x: 717, y: 265, parentGroupId: 'g-db' },
      { nodeId: 'rds-2',     type: 'rds',        label: 'RDS Standby',  x: 717, y: 470, parentGroupId: 'g-db' },
      { nodeId: 'cw-1',      type: 'cloudwatch', label: 'CloudWatch',   x: 980, y: 110 },
    ],
    edges: [
      { edgeId: 'e1', from: 'route53-1', to: 'alb-1' },
      { edgeId: 'e2', from: 'alb-1',     to: 'ec2-1' },
      { edgeId: 'e3', from: 'alb-1',     to: 'ec2-2' },
      { edgeId: 'e4', from: 'ec2-1',     to: 'rds-1' },
      { edgeId: 'e5', from: 'ec2-2',     to: 'rds-1' },
  ...
  },
  {
    ...
    nodes: [
      { nodeId: 'alb-1',  type: 'elb', label: 'ALB',        x: 200, y: 160, parentGroupId: 'g-priv' },
      { nodeId: 'ec2-1',  type: 'ec2', label: 'EC2 Spot',   x: 400, y: 240, parentGroupId: 'g-priv' },
      { nodeId: 'rds-1',  type: 'rds', label: 'RDS Single', x: 400, y: 390, parentGroupId: 'g-priv' },
    ],
    edges: [
      { edgeId: 'e1', from: 'alb-1', to: 'ec2-1' },
      { edgeId: 'e2', from: 'ec2-1', to: 'rds-1' },
    ],
  },
  {
    ...
    edges: [
      { edgeId: 'e1', from: 'apigw-1',  to: 'lambda-1' },
      { edgeId: 'e2', from: 'lambda-1', to: 'rds-1' },
    ],
  },
]
