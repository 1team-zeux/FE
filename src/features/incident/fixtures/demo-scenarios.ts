...
// Subscription API Traffic Surge — CRITICAL 시나리오 (Subscription.md v1)
// 요청량 6.2× / Task 처리 용량 부족 / Availability 4분 내 위반 임박
export const DEMO_SURGE_ASSESSMENT: TriageAssessment = {
  incident_id: 'inc-demo-surge-001',
  correlation_group_id: 'grp-demo-surge-001',
  assessment_stage: 'provisional',
  triage_priority: 'Critical',
  triage_latency_ms: 2400,
  current_state: {
    prometheus_snapshot: {
      snapshot_at: '2026-06-19T14:32:00Z',
      metrics: [
        { name: 'request_rate',   current: 3000, baseline: 500,   deviation_ratio: 6.2,  unit: 'req/s' },
        { name: 'cpu_util',       current: 95,   baseline: 40,    deviation_ratio: 2.4,  unit: 'percent' },
        { name: 'latency_p95_ms', current: 1200, baseline: 80,    deviation_ratio: 15.0, unit: 'ms' },
        { name: 'error_rate',     current: 0.08, baseline: 0.001, deviation_ratio: 80.0, unit: 'ratio' },
      ],
    },
    infra_status: {
      ecs_desired: 4,
  ...
  sla_impact: {
    affected_items: [
      {
        sla_item_id: 'sla-subscription-availability',
        category: 'Availability',
        target: 99.9,
        budget_remaining_pct: 38.0,
        burn_rate_state: 'fast',
        burn_rate_value: 14.4,
        estimated_violation_minutes: 4.0,
        current_alert_level: 'level2',
      },
      {
        sla_item_id: 'sla-subscription-latency',
        category: 'Latency',
        target: 300,
        budget_remaining_pct: 0,
        burn_rate_state: 'critical_breach',
    ...
    triage_priority: 'Critical',
    user_impact_estimate: '신규 가입 8% 실패 (5xx) · p95 1.2s 초과 · 4분 후 Availability SLA 위반 임박',
    earliest_violation_minutes: 4.0,
  },
  vector_db_hints: {
    top_cause_hypothesis: 'traffic_surge_capacity_shortage',
    hypothesis_confidence: 0.91,
    hypothesis_basis: '유사 사태 2건 모두 동일 원인 — Task 증설로 회복. 코드 / DB / 외부 API 변동 없음.',
    similar_incidents: [
      { incident_id: 'inc-20260415-0009', similarity: 0.93, confirmed_cause: 'traffic_surge_capacity_shortage', occurred_at: '2026-04-15T11:18:00Z', time_context: '프로모션시간',  resolution: 'ecs_desired_count_scaleup' },
      { incident_id: 'inc-20260221-0005', similarity: 0.88, confirmed_cause: 'traffic_surge_capacity_shortage', occurred_at: '2026-02-21T15:42:00Z', time_context: '일반운영시간', resolution: 'ecs_desired_count_scaleup' },
    ],
  },
  handoff: { to_rca: true, rca_entry_mode: 'hypothesis_first' },
  node_errors: {},
...
// 알람 피드 그룹 — 142 cap 메타 포함 가능
export type DemoFeedGroup = Alarm & {
  alarms: Alarm[];
...
// Surge(Critical, 142 cap) + Subscription DB pool(Critical) + Billing(Low)
export const DEMO_FEED_GROUPS: DemoFeedGroup[] = [
  {
    id: 'grp-demo-surge-001',
    ts: '14:32:01',
    serviceId: '2',
    serviceName: 'Subscription API (ECS Fargate)',
    severity: 'critical',
    status: 'rca_started',
    correlationGroupId: 'grp-demo-surge-001',
    triage_priority: 'Critical',
    alarmCount: 100,
    totalReceived: 142,
    groupedCount: 100,
    ...
    capApplied: true,
    alarms: [
      { id: 'alm-301', ts: '14:32:01', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'HighRequestRate',         metric: 'request_rate',           current_value: 3000,  baseline: 500,   unit: 'req/s' },
      { id: 'alm-302', ts: '14:32:02', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'HighRequestRate',         metric: 'request_rate_per_task',  current_value: 812,   baseline: 125,   unit: 'req/s' },
      { id: 'alm-303', ts: '14:32:02', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'HighCPU',                 metric: 'cpu_util',               current_value: 96,    baseline: 40,    unit: 'percent' },
      { id: 'alm-304', ts: '14:32:03', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'HighLatencyP95',          metric: 'latency_p95_ms',         current_value: 1240,  baseline: 80,    unit: 'ms' },
      { id: 'alm-305', ts: '14:32:03', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'HighCPU',                 metric: 'cpu_util',               current_value: 92,    baseline: 40,    unit: 'percent' },
      { id: 'alm-306', ts: '14:32:03', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'ErrorRate5xx',            metric: 'error_rate',             current_value: 0.041, baseline: 0.001, unit: 'ratio' },
      { id: 'alm-307', ts: '14:32:04', serviceId: '2', serviceName: 'Subscription API', severity: 'warning',  status: 'merged', source: 'metric', alert_name: 'ALBTargetRespTime',       metric: 'alb_target_resp_ms',     current_value: 1180,  baseline: 75,    unit: 'ms' },
      { id: 'alm-308', ts: '14:32:04', serviceId: '2', serviceName: 'Subscription API', severity: 'warning',  status: 'merged', source: 'metric', alert_name: 'HighMemory',              metric: 'memory_util',            current_value: 83,    baseline: 55,    unit: 'percent' },
      { id: 'alm-309', ts: '14:32:04', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'HighCPU',                 metric: 'cpu_util',               current_value: 89,    baseline: 40,    unit: 'percent' },
      { id: 'alm-310', ts: '14:32:05', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'ALB5xxRate',              metric: 'alb_5xx_rate',           current_value: 0.083, baseline: 0.001, unit: 'ratio' },
      { id: 'alm-311', ts: '14:32:05', serviceId: '2', serviceName: 'Subscription API', severity: 'warning',  status: 'merged', source: 'metric', alert_name: 'HighMemory',              metric: 'memory_util',            current_value: 79,    baseline: 55,    unit: 'percent' },
      { id: 'alm-312', ts: '14:32:05', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'HighCPU',                 metric: 'cpu_util',               current_value: 94,    baseline: 40,    unit: 'percent' },
      { id: 'alm-313', ts: '14:32:06', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'QueueDepthHigh',          metric: 'request_queue_depth',    current_value: 218,   baseline: 5,     unit: 'msg' },
      { id: 'alm-314', ts: '14:32:06', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'ALBTargetUnhealthy',      metric: 'unhealthy_targets',      current_value: 1,     baseline: 0,     unit: 'task' },
      { id: 'alm-315', ts: '14:32:07', serviceId: '2', serviceName: 'Subscription API', severity: 'critical', status: 'merged', source: 'metric', alert_name: 'HighRequestRate',         metric: 'request_rate',           current_value: 3120,  baseline: 500,   unit: 'req/s' },
    ],
  },
  {
  ...
  },
  {
    ...
    alarms: [
      ...
      { id: 'alm-004', ts: '02:17:21', serviceId: '1', serviceName: 'Billing Settlement Batch', severity: 'warning', status: 'merged', source: 'metric', alert_name: 'JvmGcPauseElevated', metric: 'gc_pause_p95_ms',     current_value: 312,  baseline: 180,  unit: 'ms' },
    ],
  },
];
...
export const DEMO_INCIDENTS = [
  { id: 'inc-demo-surge-001',        serviceName: 'Subscription API (ECS Fargate)',          severity: 'critical', status: 'open',     title: '트래픽 Surge — Task 처리 용량 부족 (142 알람 그룹화)',  startedAt: '2026-06-19T14:32:01Z', triagePriority: 'Critical' },
  ...
  { id: 'inc-20260415-0009',         serviceName: 'Subscription API (ECS Fargate)',          severity: 'critical', status: 'resolved', title: '프로모션 Surge — ECS Task 증설로 회복',                startedAt: '2026-04-15T11:18:00Z', triagePriority: 'Critical', resolvedAt: '2026-04-15T11:23:00Z' },
  { id: 'inc-20260221-0005',         serviceName: 'Subscription API (ECS Fargate)',          severity: 'critical', status: 'resolved', title: '트래픽 Surge — Auto Scaling 정책 조정으로 회복',        startedAt: '2026-02-21T15:42:00Z', triagePriority: 'Critical', resolvedAt: '2026-02-21T15:50:00Z' },
];
