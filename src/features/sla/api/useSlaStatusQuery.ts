...
const MOCK_SERVICES = [
  ...
  { service_name: 'Billing Settlement',  current_slo: 100.0, availability_target: 99.99, current_latency_p99_ms: 0,   latency_target_ms: 9999, error_budget_burn: 0.0, status: 'healthy'  },
];
