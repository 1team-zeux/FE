...
export const mainNav: NavItem[] = [
  ...
  {
    label: 'Event Center', match: '/dashboard/events', to: '/dashboard/events', hasChevron: false,
  ...
  {
    label: 'FinOps', match: '/dashboard/finops', to: '/dashboard/finops', hasChevron: false,
